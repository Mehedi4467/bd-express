...
import { View, TextInput, Button, StyleSheet, Text, TouchableOpacity, ActivityIndicator, ScrollView } from 'react-native';
...
<View style={{flexDirection: 'row',alignItems: 'center',justifyContent: 'flex-end'}}>
{
      ...
      
      {
        ...
        <TouchableOpacity style={{backgroundColor:'#00aeef',borderRadius:5,padding:4}}>
