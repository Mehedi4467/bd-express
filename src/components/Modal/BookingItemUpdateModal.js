...
export default function BookingItemUpdateModal({visible,setFormValues,formValues,openINdex,setVisible}) {
    const [disabled, setDisabled] = useState(false);
    const [ModalValue, setModalValue] = useState([...formValues[openINdex]?.item]);
    ...
    let removeFormFields = (i) => {
      ...
      newFormValuess[openINdex]['item'] = newFormValues;
    ...
    const OnSvae = () =>{
      let newFormValuess = [...formValues];
      newFormValuess[openINdex]['item'] = ModalValue;
      setFormValues(newFormValuess);
      hideModal();
    }
